...
const areaMap = {
    'tenma': ['天満', '天神橋', '南森町', '扇町'],
    'namba': ['難波', 'なんば', '道頓堀', '千日前', '日本橋', '心斎橋', '堀江'],
    'tsuruhashi': ['鶴橋', '桃谷', '生野', '今里'],
    'umeda': ['梅田', '北新地', '西梅田', '東梅田', '茶屋町', '中崎町'],
    'shinsekai': ['新世界', '西成', '通天閣', '恵美須'],
    'kyobashi': ['京橋', '都島', '野江'],
    'abeno': ['阿倍野', '天王寺', '寺田町'],
...
// ジャンル判定用キーワード
const genreMap = {
    'tachinomi': ['立ち飲み', '立呑', 'スタンド', '立食'],
    'yakitori': ['焼き鳥', '焼鳥', '鶏', '鳥'],
    'kushikatsu': ['串カツ', '串揚げ', '串揚'],
    'izakaya': ['居酒屋', '酒場', '大衆'],
    'ramen': ['ラーメン', 'らーめん', '中華そば', '餃子'],
    'yakiniku': ['焼肉', '焼き肉', 'ホルモン', 'ステーキ'],
    'sushi': ['寿司', '鮨', '海鮮', '魚', 'カニ'],
    'bar': ['バー', 'BAR', '角打ち', 'ワイン'],
};
