...
function run() {
    console.log('Applying Batch 4 results...');
    ...
    const salvageIds = ["156", "157", "158", "169", "170", "171", "172", "173", "174", "175", "176", "177", "178", "180", "181", "182", "183", "184"];
    ...
    console.log(`- Excluded: ${allToVerify.length - salvagedShops.length}`);
